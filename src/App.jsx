...
// --- TODOS OS DADOS HISTÓRICOS DA PLANILHA DA ANA INTEGRADOS ---
const initialReservations = [
  ...
  {"id":"lit-5","client_name":"Aldinar Bontentuir","contact":"98 98866-7191","date":"2026-04-01","time":"19:00","guests":"5","period":"jantar","space":"Vista Mar","status":"confirmada","notes":"Aniversário","unit":"Litorânea"},
  {"id":"lit-6","client_name":"Sarah Raquel","contact":"98 98143-2629","date":"2026-04-02","time":"19:30","guests":"16","period":"jantar","space":"Geral","status":"confirmada","notes":"","unit":"Litorânea"},
  {"id":"lit-7","client_name":"Grupo Equatorial - RH","contact":"98 99112-4455","date":"2026-04-02","time":"12:00","guests":"25","period":"almoço","space":"Vista Mar","status":"confirmada","notes":"Corporativo","unit":"Litorânea"},
  {"id":"lit-8","client_name":"Mariana Costa (Níver)","contact":"98 98223-1122","date":"2026-04-03","time":"21:00","guests":"12","period":"jantar","space":"VIP I","status":"confirmada","notes":"Aniversário","unit":"Litorânea"},
  {"id":"lit-9","client_name":"Carlos Eduardo Silva","contact":"98 98776-5544","date":"2026-04-03","time":"20:30","guests":"4","period":"jantar","space":"Geral","status":"pendente","notes":"","unit":"Litorânea"},
  {"id":"lit-10","client_name":"Dra. Camila Rocha","contact":"98 98144-8899","date":"2026-04-04","time":"13:00","guests":"8","period":"almoço","space":"Vista Mar","status":"confirmada","notes":"","unit":"Litorânea"},
  {"id":"far-1","client_name":"Milton Campelo","contact":"9892001444","date":"2026-03-04","time":"19:00","guests":"25","period":"jantar","space":"Geral","status":"confirmada","notes":"","unit":"Farol"},
  {"id":"far-2","client_name":"Leandro José","contact":"98981510453","date":"2026-02-04","time":"12:00","guests":"6","period":"almoço","space":"Geral","status":"confirmada","notes":"","unit":"Farol"},
  {"id":"far-3","client_name":"Marla Calvet","contact":"98984011481","date":"2026-04-04","time":"12:00","guests":"15","period":"almoço","space":"Geral","status":"confirmada","notes":"","unit":"Farol"},
  {"id":"far-4","client_name":"Rita Bayma","contact":"98984155718","date":"2026-04-04","time":"19:00","guests":"8","period":"jantar","space":"Geral","status":"confirmada","notes":"aniversario","unit":"Farol"},
  {"id":"far-5","client_name":"Igor Figueiredo","contact":"98983415999","date":"2026-04-05","time":"19:00","guests":"5","period":"jantar","space":"Geral","status":"confirmada","notes":"","unit":"Farol"},
  {"id":"far-6","client_name":"Filipe Marreca","contact":"98981899446","date":"2026-04-06","time":"20:00","guests":"10","period":"jantar","space":"Geral","status":"confirmada","notes":"","unit":"Farol"},
  {"id":"far-7","client_name":"Concita Guterres","contact":"98970293394","date":"2026-04-07","time":"12:30","guests":"25","period":"almoço","space":"Geral","status":"confirmada","notes":"","unit":"Farol"}
];
                ...
                {['Qua 01/04', 'Qui 02/04', 'Sex 03/04', 'Sáb 04/04', 'Dom 05/04'].map((day, idx) => (
                  <div key={idx} className="bg-slate-950 p-4 rounded-xl border border-slate-800 min-w-[140px] text-center shadow-inner">
                    ...
                    <p className="text-xl font-black text-white">
                      {reservations.filter(r => r.unit === selectedUnit && r.date.includes(`-04-0${idx+1}`) && r.status === 'confirmada').length} res
                    </p>
                  </div>
                ))}
              </div>
                  ...
                  <tbody className="divide-y divide-slate-800/50 text-sm">
                    {filteredReservations.map((res) => (
                      <tr key={res.id} className="hover:bg-slate-850/40 transition">
                        ...
                        <td className="px-6 py-4"><p className="text-slate-200 font-medium">{res.date}</p><p className